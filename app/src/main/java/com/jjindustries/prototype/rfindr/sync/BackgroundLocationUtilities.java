...
public class BackgroundLocationUtilities {
    /*
    ...
    private static final String BACKGROUND_LOCATION_JOB_TAG = "background_location_tag";
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setService(BackgroundLocationFirebaseJobService.class)
                /*
                 * Set the UNIQUE tag used to identify this Job.
                 */
                .setTag(BACKGROUND_LOCATION_JOB_TAG)
                /*
